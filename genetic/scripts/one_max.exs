# create initial population (100 individuals, each chromosome has 1000 elements
population = for _ <- 1..100, do: for _ <- 1..1000, do:
  Enum.random(0..1)

# fitness function: simply count number of ones
evaluate = 
  fn population -> 
  ...
  fn population -> 
    Enum.reduce(population, [],
      fn {p1, p2}, acc ->
        ...
        # create new chromosome using single-point crossover
        {{h1, t1}, {h2, t2}} = 
